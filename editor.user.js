...
(()=>{
	...
	const MISSPELLINGS = Object.assign({},...(
		"Android|AngularJS|Apache|CakePHP|CentOS|CMake|CodeIgniter|Cordova|cPanel|Debian|Delphi|Django|ECMAScript|English|Excel|Facebook|Firebase|Firefox|Flutter|Git|Google|Gradle|Grails|Hadoop|Haskell|Heroku|Highcharts|Jakarta|Jenkins|Joomla|JUnit|I'd|I'll|IntelliJ|iPhone|iPod|IIS|Java|Kafka|Keras|Kotlin|Kubernetes|Laravel|Linux|macOS|Magento|Maven|Matplotlib|MongoDB|Nginx|Microsoft|NumPy|OpenCV|OpenGL|OpenSSL|Oracle|Pandas|Perl|PowerShell|PostgreSQL|PySpark|Qt|Selenium|SharePoint|Silverlight|SwiftUI|TensorFlow|Twitter|TypeScript|UITableView|Unix|WinForms|WooCommerce|Xamarin|Xcode|YouTube|"+
		"AJAX|API|AWK|AWS|CMS|CSS|CSV|DNS|DLL|DOM|EC2|GCC|GIF|GUI|HTTP|HTTPS|HTML|HTML5|I|IIS|IP|JDBC|JPA|JPG|JPEG|JSON|JSP|LINQ|MATLAB|MVC|MVVM|OK|OOP|ORM|PDF|PHP|PNG|SEO|SMTP|SQL|SSH|SSL|SVG|SVN|TLS|URI|URL|USB|VBA|VPN|XAML|WCF|XML|WPF|"+
